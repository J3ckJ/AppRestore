...
def test_payload_installer_is_user_space_and_transactional() -> None:
    ...
    assert 'APPRESTORE_VERSION="0.2.3"' in installer
    ...
    assert 'IPATOOL_VERSION="2.5.0"' in installer
    assert "8d6c42230215e8a9dc939b537ae7bb2d" in installer
    assert "1b8bbf14e717ef6827a78e6dcb67bd09" in installer
...
def test_payload_installs_apprestore_for_the_same_terminal_path(
    ...
    assert launched.stdout.strip() == "0.2.3"
